...
function isCollide(a,b) // a player car b is enemy car
{
...
function GamePlay()
{
    ...
    let road = gameArea.getBoundingClientRect();//providing information about the size of an element and its position relative to the viewport
...
//    gameArea.classList.remove('hide');
   ...
   gameArea.innerHTML = "";
    ...
    // car.innerHTML = "hay i am your car";
